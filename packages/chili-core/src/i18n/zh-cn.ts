...
export default {
    ...
    translation: {
        ...
        "command.create.leader": "引线",
        "command.create.text": "文字",
        "command.create.mtext": "多行文字",
        ...
        "command.dimension.horizontal": "水平标注",
        "command.dimension.vertical": "垂直标注",
        "command.dimension.aligned": "对齐标注",
        ...
        "common.type": "类型",
        "common.volume": "体积",
        "common.customProperties": "自定义属性",
        "text.content": "内容",
        "text.height": "高度",
        "text.color": "颜色",
        "text.horizontalAlign": "水平对齐",
        "text.verticalAlign": "垂直对齐",
        "mtext.lineSpacing": "行间距",
        "mtext.lineColors": "行颜色",
        "leader.associative": "关联",
        "leader.startNodeId": "起点节点ID",
        "leader.startShapeType": "起点形状类型",
        "leader.startLocalPoint": "起点局部点",
        "leader.startMode": "起点模式",
        "leader.endNodeId": "终点节点ID",
        "leader.endLocalPoint": "终点局部点",
        "leader.endMode": "终点模式",
        ...
        "home.recent": "最近使用",
        "home.welcome": "欢迎使用",
        "home.new.2d": "新建 2D 文档",
        "home.new.3d": "新建 3D 文档",
        "items.header": "项目",
        ...
        "polygon.points": "点",
        "layer.title": "图层",
        "layer.lineType.solid": "实线",
        "layer.lineType.dash": "虚线",
        "layer.isolate": "隔离",
        "layer.unisolate": "取消隔离",
        "layer.add": "添加",
        "layer.showAll": "全部显示",
        "layer.locked": "锁定",
        ...
        "prompt.pickDimensionLocation": "请选择标注位置，按 ESC 键取消",
