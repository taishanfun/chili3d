...
export default {
    ...
    translation: {
        ...
        "body.textNode": "Texto",
        "body.mtextNode": "Texto Multilinha",
        "body.dimensionNode": "Cota",
        "body.leaderNode": "Linha de Chamada",
        ...
        "command.create.leader": "Linha de Chamada",
        "command.create.text": "Texto",
        "command.create.mtext": "Texto Multilinha",
