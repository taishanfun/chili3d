...
export class BoundingBox {
    ...
    static zero = new BoundingBox(new XYZ(0, 0, 0), new XYZ(0, 0, 0));
    static transformed(box, matrix) {
    ...
    static isIntersect(box1, box2, tolerance = 0.001) {
        return (
    ...
    static isInside(box, point, tolerance = 0.001) {
        return (
    ...
    static expandByPoint(box, point) {
        const { min, max } = box;
