...
import { MathUtils, Matrix4, PhongMaterial, PhysicalMaterial, XYZ } from "chili-core";
import {
    Box3,
    DoubleSide,
    RepeatWrapping,
...
export class ThreeHelper {
    ...
    static fromXYZ(vector) {
        return new Vector3(vector.x, vector.y, vector.z);
    }
    static isPerspectiveCamera(camera) {
        return camera.isPerspectiveCamera;
    }
    static isOrthographicCamera(camera) {
    ...
    static findGroupIndex(groups, subIndex) {
    ...
    static parsePhysicalMaterial(material) {
    ...
    static parsePhongMaterial(material) {
    ...
    static parseBasicMaterial(material) {
    ...
    static parseToThreeMaterial(material) {
