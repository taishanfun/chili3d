...
import { MathUtils, Observable, ViewMode, VisualNode } from "chili-core";
import {
    Box3,
    Camera,
    OrthographicCamera,
...
export class CameraController extends Observable {
    ...
    _height = 100;
    _target = new Vector3();
    _position = new Vector3(1500, 1500, 1500);
    _rotateCenter;
    _camera;
    get cameraType() {
    ...
    getBoundingSphere(context) {
        ...
        for (let shape of shapes) {
            let threeGeometry = context.getVisual(shape);
    ...
    caclueZoomFactor(x, y, direction) {
    ...
    caculePerspectiveCameraMouse(direction, mouse) {
