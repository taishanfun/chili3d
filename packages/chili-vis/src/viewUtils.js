...
import { Plane, Precision, Ray, XYZ } from "chili-core";
export class ViewUtils {
    static rayFromEye(view, point) {
    ...
    static raycastClosestPlane(view, start, end) {
        const direction = view.direction();
        ...
        let result = [planes[0], distances[0]];
