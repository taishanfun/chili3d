...
describe("converter test", () => {
    test("test type", () => {
        ...
        expect(converters.every((x) => x.convert !== undefined)).toBeTruthy();
    });
    ...
    test("test ColorConverter", () => {
        ...
        expect(converter.convert(undefined).value).toBe("#808080");
        expect(converter.convert(null).value).toBe("#808080");
        expect(converter.convert("").value).toBe("#808080");
        expect(converter.convert("invalid").value).toBe("#808080");
        expect(converter.convert(NaN).value).toBe("#808080");
        // Test convertBack
