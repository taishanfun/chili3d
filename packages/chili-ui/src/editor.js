...
let quickCommands = ["doc.save", "doc.saveToFile", "edit.undo", "edit.redo"];
export class Editor extends HTMLElement {
    ...
    showSelectionControl = (controller) => {
    ...
    _handleMaterialEdit = (document, editingMaterial, callback) => {
    ...
    registerRibbonCommand(tabName, groupName, command) {
