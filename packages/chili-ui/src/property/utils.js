...
import { Logger, MTextNode, Texture } from "chili-core";
...
export function findPropertyControl(document, objs, prop, converter) {
...
function canShowMaterialProperty(objs, prop) {
