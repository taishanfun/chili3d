...
export class ToolBar extends HTMLElement {
    ...
    private createLayerDialogContent(document: IDocument) {
        const panel = div();
    ...
    private reassignLayerId(document: IDocument, fromLayerId: string, toLayerId: string) {
