...
import { Constants, I18n, Localize, ObservableCollection, PubSub } from "chili-core";
...
export class Home extends HTMLElement {
    ...
    applicationCommands() {
        const applicationCommands = new ObservableCollection(
            {
                display: "home.new.3d",
                onclick: () =>
                    PubSub.default.pub(
